                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="{{ url('vendor/products') }}">
                        <button type="button" class="btn btn-default dropdown-toggle waves-effect waves-light"
                            aria-expanded="false">
                            @lang('lang.manage_your_products')
                        </button>
                    </a>
                </div>
                ...
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable-fixed-col" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 10%; height:100px"> <img src="{{ url($product->images[0]->image_url) }}" style="width: 100%; height:100%" alt="product_image"> </td>
        ...
        Swal.fire({
          ...
          cancelButtonText: "@lang('lang.alert_cancel')"
            ...
            if (result.isConfirmed) {
                $.ajax({
                url:"{{ url(app()->getLocale() . '/admin/products') . '/' }}" + id,
                type:'DELETE',
