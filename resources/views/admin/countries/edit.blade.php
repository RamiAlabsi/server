...
<div class="content">
    <div class="container">
        <form class="form-horizontal" role="form"
            action="{{ url(app()->getLocale() . '/admin/countries/' . $country->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="name[]"
                                                value="{{ $country->translation->name }}" required>
                                        </div>
                                    </div>
                                </bdo>
                                @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="code" maxlength="4" pattern="[0-9]{1,4}"
                                            ...
                                            onchange="setCustomValidity('')" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="iso" value="{{$country->iso}}" maxlength="3" 
