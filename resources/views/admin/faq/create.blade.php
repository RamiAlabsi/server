...
<div class="content">
    ...
    <div class="container">
        <form class="form-horizontal" role="form" action="{{ url(app()->getLocale() . '/admin/faq') }}"
            method="POST">
            @csrf
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="general_question" required>
                                        <option value="1">@lang('lang.general_questions')</option>
                                        <option value="0">@lang('lang.other_questions')</option>
                                    </select>
                                </div>
                            </div>
