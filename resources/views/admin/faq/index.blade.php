    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">@lang('lang.faq')</h4>
                    ...
                    <table id="datatable-fixed-col" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($faq->general_question)
                                        @lang('lang.general_questions')
                                    @else
                                        @lang('lang.other_questions')
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="javascript:void(0)" data-delete-id="{{ $faq->id }}"
        ...
        Swal.fire({
          ...
          cancelButtonText: "@lang('lang.alert_cancel')"
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url:"{{ url(app()->getLocale() . '/admin/faq') . '/' }}" + id,
                    type:'DELETE',
