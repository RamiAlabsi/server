    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">@lang('lang.states')</h4>
                    ...
                    <table id="datatable-fixed-col" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $state->code }}</td>
                                <td>{{ $state->country->translation->name }}</td>
                                <td>
                                    <a href="{{ url('admin/states/' . $state->id . '/edit') }}"
                                        class="warning btn btn-warning">
                                        <i class="fa fa-edit text-white"></i>
                                    </a>
                                    <a href="javascript:void(0)" data-delete-id="{{ $state->id }}"
        ...
        Swal.fire({
          ...
          cancelButtonText: "@lang('lang.alert_cancel')"
            ...
            if (result.isConfirmed) {
                $.ajax({
                url:"{{ url(app()->getLocale() . '/admin/states') . '/' }}" + id,
                type:'DELETE',
