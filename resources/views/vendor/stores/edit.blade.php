...
<div class="content">
    ...
    <div class="container">
        <form class="form-horizontal" action="{{ url(app()->getLocale() . '/vendor/stores/' . $store->id)  }}" method="POST" role="form">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="name[]" class="form-control"
                                                value="{{ $store->translation->name }}" required>
                                        </div>
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="description[]" class="form-control"
                                                value="{{ $store->translation->description }}" required>
                                        </div>
